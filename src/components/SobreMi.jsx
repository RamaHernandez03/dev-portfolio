...
const SobreMi = () => {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gray-800 p-4 md:p-8">
      <h2 id='SobreMi' className="font-semibold pb-[5px] border-b-4 border-orange-500 text-[40px] sm:text-[30px] md:pb-5 md:text-[40px] text-white mb-[60px] sm:mb-[40px] md:mb-[80px]">
        Sobre Mi
      </h2>
